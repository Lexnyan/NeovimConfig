...
if not ok then
  vim.api.nvim_err_writeln("Error al cargar el plugin 'noice': " .. noice)
  return
end

local function handle_error(err)
  vim.api.nvim_err_writeln("Error en la configuración de 'noice': " .. err)
end
...
vim.api.nvim_out_write("configuración de 'noice' cargada con éxito\n")
