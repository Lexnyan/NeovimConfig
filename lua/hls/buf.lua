...
return {
  ...
  BuffLineRun = { bg = utils.darken(colors.color1, colors.cursorline, 0.12), fg = colors.color1 },
  BuffLineSplit = { bg = utils.darken(colors.color10, colors.cursorline, 0.12), fg = colors.color10 },
