...
return {
  ...
  CmpItemKindEnum = { fg = colors.darker, bg = colors.base03 },
  ...
  CmpItemKindNumber = { fg = colors.darker, bg = colors.base05 },
  CmpItemKindObject = { fg = colors.darker, bg = colors.base04 },
  ...
  CmpItemKindText = { fg = colors.darker, bg = colors.red },
