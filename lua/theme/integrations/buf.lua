...
return {
  ...
  -- OLD BUFFERLINE HIGHLIGHTS

  BufflineBufOnActive = { bg = colors.base09, fg = colors.base00 },
  BufflineBufOnInactive = { fg = colors.base07, bg = colors.base00 },
  BuffLineBufOnModified = { bg = colors.base09, fg = colors.base00 },
  BuffLineBufOffModified = { fg = colors.base0F, bg = colors.base00 },
  BuffLineBufOnClose = { bg = colors.base09, fg = colors.base00 },
