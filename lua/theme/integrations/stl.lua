...
return {
  ...
  StalineFilenameSep = { fg = colors.lighter, bg = colors.base00 },
  ...
  StalineDiffAddFancy = { bg = utils.blend(colors.base0B, colors.base00, 0.07), fg = colors.base0B },
  StalineDiffAddMinimal = { bg = colors.base00, fg = colors.lighter },
  StalineDiffChange = { bg = colors.background, fg = colors.base0A },
  StalineDiffChangeFancy = { bg = utils.blend(colors.base0A, colors.base00, 0.07), fg = colors.base0A },
  StalineDiffChangeMinimal = { bg = colors.base00, fg = colors.base0A },
  StalineDiffRemoveFancy = { bg = utils.blend(colors.base08, colors.base00, 0.07), fg = colors.base08 },
